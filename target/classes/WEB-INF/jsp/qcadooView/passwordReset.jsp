...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet"
            ...
            type="text/css"/>
        <link rel="stylesheet"
            href="${pageContext.request.contextPath}/qcadooView/public/css/core/passwordReset-min.css?ver=2025_10_18_10_15"
            type="text/css"/>
        ...
        <script type="text/javascript"
            src="${pageContext.request.contextPath}/qcadooView/public/js/core/qcd/utils/serializator.js?ver=2025_10_18_10_15"></script>
        <script type="text/javascript"
            src="${pageContext.request.contextPath}/qcadooView/public/js/core/passwordReset-min.js?ver=2025_10_18_10_15"></script>
    </head>
        ...
        <div class="container" role="main">
            ...
            <div class="passwordResetContainer">
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="usernameInput" name="login" class="form-control" placeHolder="${translation["security.form.label.login"]}" value='<c:if test="${not empty param.login_error}"><c:out value="${SPRING_SECURITY_LAST_USERNAME}"/></c:if>' autocomplete="off" required autofocus/>
