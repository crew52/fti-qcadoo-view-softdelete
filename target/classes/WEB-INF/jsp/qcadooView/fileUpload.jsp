    ...
    <head>
        <c:choose>
            <c:when test="${useCompressedStaticResources}">
                ...
                <script type="text/javascript" src="${pageContext.request.contextPath}/qcadooView/public/js/core/lib/_jquery-1.4.2.min.js?ver=2025_10_18_10_15"></script>
                <script type="text/javascript" src="${pageContext.request.contextPath}/qcadooView/public/js/core/lib/jquery-ui-1.8.5.custom.min.js?ver=2025_10_18_10_15"></script>
            ...
            <c:otherwise>
                <link rel="stylesheet" href="${pageContext.request.contextPath}/qcadooView/public/css/core/login.css?ver=2025_10_18_10_15" type="text/css" />
